! function(a) {
    a.fn.passwordRulesValidator1 = function(b) {
        function d(b, c, d, e) {
        ...
        return this.each(function() {
            ...
            }), oRulesBuilder += "</ul>", "undefined" == typeof f.container ? (a(this).after('<div class="rules-list1 ' + f.containerClass + '" id="' + f.containerId + '"></div>'), a(oRulesBuilder).appendTo("#" + f.containerId)) : (f.container.addClass("rules-list1"), a(oRulesBuilder).appendTo(f.container));
