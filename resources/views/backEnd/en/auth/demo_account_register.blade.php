          ...
          <div class="col-md-12 col-xs-12  form-div-height">
            ...
            <div class="col-md-8 col-md-push-5 col-xs-12  col-sm-8 text-center">
              ...
              <form id="myform" method="post" action="{{LaravelLocalization::localizeURL('/demo-account-register')}}">
                ...
                <fieldset id="x">
                  <h2 class="fs-title">Demo Account Register</h2>
                  <hr>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-5 col-md-push-1">
                      <div class="form-group" class="small-device-style">
                        ...
                        <label class="control-label" for="input" style="">Confirm Trading Password</label><i class="bar"></i>
                      </div>
                    </div>
                  </div>
                  <div class="row upper-margin">
                    ...
                    <div class="col-md-5 col-md-push-1">
                      <div class="form-group" class="small-device-style">
                        ...
                        <label class="control-label" for="input" style="">Confirm Investor Password</label><i class="bar"></i>
                      </div>
                    </div>
                  </div>
                  <div class="row upper-margin1">
                    <div class="col-md-5 col-md-push-1">
                      <div class="form-group">
                        ...
                        <label class="control-label" for="input" style="">Amount</label><i class="bar"></i>
                      </div>
                    </div>
                    <div class="col-md-5 col-md-push-1">
                      <div class="form-group">
