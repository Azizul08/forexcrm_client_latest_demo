...
<div style="Margin:0;">
                                    ...
                                    <table cellpadding="0" cellspacing="0" style="width:calc(100% - 40px);margin:auto;text-align:left;padding:30px 20px 0px" dir="ltr">
                                        ...
                                        <tr>
                                                <td mc:hideable="" mc:edit="" class="heroSubTitle" align="center" valign="middle" style="font-family:'Lato', sans-serif;color:#37393d;font-size:12px;line-height:20px;font-weight:400;letter-spacing:0px;padding:0;padding-bottom:15px; text-align: left;">
                                                    We have received your request to <b>change the password</b> on your {{$mail_data['company_name']}} account. In order to proceed with your request, simply enter the unique <b>Pin Number</b> below.
                                                </td>
                                            </tr>
                                            ...
                                            <td align="center" valign="top">
                                                ...
                                                <tr>
                                                <td class="heroSubTitle" align="center" valign="middle" style="font-family: 'Lato',sans-serif;
    color: #515152;
    font-size: 16px;
    line-height: 20px;
    font-weight: 600;
    letter-spacing: 0px;
    padding: 0;
    text-align: center;">Pin:&nbsp; &nbsp; &nbsp; &nbsp;{{ $investor_password }}</td>
                                            </tr>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <tr>
                                            <td mc:hideable="" mc:edit="" class="heroSubTitle" align="center" valign="middle" style="font-family:'Lato', sans-serif;color:#37393d;font-size:12px;line-height:20px;font-weight:400;letter-spacing:0px;padding:0px 40px; text-align: left;">
                                        ...
                                        <tr>
                                            <td align="center" valign="top">
                                                <table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 100%;">
                                                    <tbody>
                                       <tr>
                                            <td mc:hideable="" mc:edit="" class="sectionDesc" align="left" valign="middle" style="font-family:'Open Sans',Arial,Helvetica,sans-serif;color:#039ecd;font-size:14px;line-height:22px;font-weight:400;font-style: italic; letter-spacing:0px;background: #ffffff; padding: 20px 40px;">
                                                Contact Info :
                                            </td>
                                        </tr>
                                                    <tr>
                                                        <td mc:hideable="" mc:edit="" align="left" valign="middle" style="vertical-align: top; width: 50%;padding-left: 40px;">
