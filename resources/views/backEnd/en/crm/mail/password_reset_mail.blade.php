    ...
    <center>
        <div class="m_7178298702458433966webkit">
            <table align="center" cellpadding="0" cellspacing="0" border="0" style="width:98%;Margin:0 auto;background-color:#ffffff">
                ...
                <a data-color="Hero Button" href="{{ $link = url('/reset-password-successful', $token).'?email='.urlencode($newAccount->email) }}" style="text-decoration:none; color:#FFFFFF; cursor: pointer;">Confirm Mail !</a>
                                                        </td>
                                                    </tr>
                                                    </tbody></table>
                                            </td>
