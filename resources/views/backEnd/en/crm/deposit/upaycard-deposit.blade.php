...
@section('title', 'UPay Card Deposit')
            ...
            <div class="inner bg-container">
                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        @endif
                        {!! Form::open(['method' => 'POST','files' => true, 'url' => LaravelLocalization::localizeURL('/upaycard-deposit'), 'name' => 'withdrawForm','class'=>'col-md-7','id'=>'upayForm']) !!}
                        @if($errors->any())
                        ...
                        <div class="form-group show-form">
                            ...
                            {!! Form::label('userName', 'UPay Card User ID *') !!}
                            {!! Form::text('userName', null, ['class' => 'form-control input-lg','id'=>'userName', 'placeholder' => 'Enter UPay Card User ID']) !!}
                            <small class="text-danger">{{ $errors->first('userName') }}</small>
                        </div>

                        <div class="form-group show-form">

                            {!! Form::label('userAccount', 'UPay Card Account *') !!}
                            {!! Form::text('userAccount', null, ['class' => 'form-control input-lg','id'=>'userAccount', 'placeholder' => 'Enter UPay Account']) !!}
                            <small class="text-danger">{{ $errors->first('userAccount') }}</small>
                        </div>
