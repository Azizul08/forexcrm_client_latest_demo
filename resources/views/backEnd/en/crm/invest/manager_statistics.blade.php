...
@section('title') Manager Statistics @parent
        ...
        <div class="row">
            <div class="col-lg-6 col-md-4 col-sm-4">
                <h4 class="nav_top_align">
                    <i class="fa fa-th"></i> Manager Statistics
                </h4>
            </div>
            <div class="col-lg-6 col-md-8 col-sm-8">
                <ol class="breadcrumb float-right nav_breadcrumb_top_align">
                    ...
                    <li class="breadcrumb-item active">Manager Statistics</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-12 data_tables">
                ...
                <div class="card">
                    <div class="card-block">
                        ...
                        <p> Profit share: {{ ($managerSettings && $managerSettings->profit_sharing) ? $managerSettings->profit_sharing
                            : 0 }} %</p>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-block">
                        ...
                        <p> Profitable Trades: {{ $profitableTrade }} ({{ ($totalTrades > 0) ? round(($profitableTrade*100)/$totalTrades,
                            2) : 0 }} %)</p>
                        ...
                        <p> Sell: {{ $sellTrades }} ({{ ($totalTrades > 0) ? round(($sellTrades*100)/$totalTrades, 2) : 0 }}
                            %)
                        </p>
...
<script src="/assets/invest/highcharts.js"></script>
