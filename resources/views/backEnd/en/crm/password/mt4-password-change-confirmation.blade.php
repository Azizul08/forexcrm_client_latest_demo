...
<div id="content" class="bg-container">
    ...
    <div class="outer">
        <div class="inner bg-container">
            ...
            <!--top section widgets-->
           <p style="margin-top:50px;line-height: 50px;font-size: 32px;"><span style="color:green;">Congratulations.</span> Your new Trading Account Password has been sent to <span style="font-weight: bold;">{{session('login_email')}}</span>.</p>
