                        ...
                        @endif
                            {!! Form::open(['method' => 'POST','files' => true, 'url' => LaravelLocalization::localizeURL('/open-demo-account'), 'name' => 'withdrawForm','class'=>'col-md-7 form form-horizontal','id'=>'form_id']) !!}
                                <div class="form-group">
                                        <div class="span8"><label class="control-label">Deposit:</label></div>
                                    ...
                                    <div class="form-group">
                                        <div class="span4"><label class="control-label">Account Type:</label></div>
                                  ...
                                  <div class=" form-group">
                                     ...
                                     <a href="/open-new-account" style="margin-left: 10px">Previous Step</a> 
...
<script type="text/javascript">
        $(function(){
            ...
            var form = $("#form_id");
                ...
                messages:{
                    deposit : {
                        required :"Please enter deposit value"
                    },
                    account_type:{
