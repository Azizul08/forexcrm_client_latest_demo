...
@section('title', 'Handelskonto eröffnen')
                              ...
                              <div class="span12 grey_bg">
                                <div class="padding15">
                                  ...
                                  <div class="form-group">
                                    <div class="span3"><label class="control-label">Ich möchte ein Konto eröffnen:</label></div>
                                    <div class="span4 form-group">
                                      <select name="account_type" class="form-control" id="account_type" required="required" style="width: 60%">
                                        <option value="">Wählen Sie den Kontotyp</option>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="span4"></div>
                                      ...
                                      <div class="form-group">
                                        <label for="c_password">Passwort bestätigen:</label>
