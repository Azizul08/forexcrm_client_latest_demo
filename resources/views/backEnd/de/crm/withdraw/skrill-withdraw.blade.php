            ...
            <div class="card">
                ...
                <div class="card-block m-t-35">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="show-transfer-hide">
                                ...
                                <span>Wie man Skrill transferiert</span>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="form-group show-form">
                        ...
                        {!! Form::email('email', null, ['class' => 'form-control input-lg', 'placeholder' => 'Geben Sie die Skrill E-Mail-Adresse ein']) !!}
                    ...
                    <div class="form-group hide-form">
                        ...
                        <tr>
                            <td style="font-weight:bold">Skrill E-Mail *</td>
                            <td class="email"></td>
                        </tr>
