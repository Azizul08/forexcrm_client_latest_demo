            ...
            <div class="card">
                ...
                <div class="card-block m-t-35">
                    ...
                    <div class="form-group show-form">
                        ...
                        {!! Form::label('email', 'Neteller E-Mail *') !!}
                        {!! Form::email('email', null, ['class' => 'form-control input-lg',  'placeholder' => 'Geben Sie die Neteller-E-Mail-Adresse ein']) !!}
                    ...
                    <div class="form-group hide-form">
                        ...
                        <tr>
                            <td style="font-weight:bold">Neteller E-Mail *</td>
                            <td class="email"></td>
                        </tr>
