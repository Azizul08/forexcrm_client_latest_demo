                            ...
                            <div class="col-md-12">
                                ...
                                <div class="main-table">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="frt-td1"><img src="/img/bank_trasfer-513.png" alt="" class="img-responsive" height="40px"><span><a href="/bank-withdraw-funds">Bank Transfer</a></span></td>
                                                ...
                                                <td class="last-td">
                                                    @if($selected_account)
                                                    <a href="/bank-withdraw-funds?ac={{$selected_account}}"><button>Auszahlung</button></a>
                                                    @else
                                                    <a href="/bank-withdraw-funds"><button>Auszahlung</button></a>
                                                    @endif
                                                </td>
                                            </tr>
                                        </tbody>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="last-td">
                                                    @if($selected_account)
                                                    <a href="/skrill_withdraw?ac={{$selected_account}}"><button>Auszahlung</button></a>
                                                    @else
                                                    <a href="/skrill_withdraw"><button>Auszahlung</button></a>
                                                    @endif
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="last-td">
                                                     @if($selected_account)
                                                    <a href="/neteller_withdraw?ac={{$selected_account}}"><button>Auszahlung</button></a>
                                                    @else
                                                    <a href="/neteller_withdraw"><button>Auszahlung</button></a>
                                                    @endif
                                                </td>
                                            </tr>
                                            <!-- <tr>
                                                ...
                                                <td class="last-td">
                                                     @if($selected_account)
                                                    <a href="/okpay_withdraw?ac={{$selected_account}}"><button>Auszahlung</button></a>
                                                    @else
                                                    <a href="/okpay_withdraw"><button>Auszahlung</button></a>
                                                    @endif
                                                </td>
                                            </tr> -->
                                            <tr>
                                                ...
                                                <td class="last-td">
                                                    @if($selected_account)
                                                    <a href="/perfect_money_withdraw?ac={{$selected_account}}"><button>Auszahlung</button></a>
                                                    @else
                                                    <a href="/perfect_money_withdraw"><button>Auszahlung</button></a>
                                                    @endif
                                                </td>
                                            </tr>
                                        </tbody>
