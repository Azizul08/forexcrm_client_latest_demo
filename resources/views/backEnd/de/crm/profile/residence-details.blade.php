...
@section('title', 'Wohnsitzverifizierung')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="dropFile-notice">
                                            ...
                                            <br>
                                            Um Ihre Wohnadresse zu überprüfen, laden Sie bitte Fotos hoch oder scannen Sie eins der folgenden Dokumente:
                                            <br>
                                            <ul style="list-style: inside;padding: 0">
                                                <li>Erhalt der Zahlung von Versorgungsleistungen;</li>
                                                <li>Kontoauszug;</li>
                                                <li>Seite des lokalen Reisepasses mit Wohnadresse (wenn die dort angegebene Adresse mit der aktuellen Adresse übereinstimmt und Sie die erste Seite des lokalen Reisepasses als Nachweis Ihrer Identität hochgeladen haben).</li>
                                            </ul>
                                            
                                            Wir akzeptieren hochauflösende Fotos in Farbe oder Kopien von Dokumenten, bei denen Ihr vollständiger Name und Ihre Adresse deutlich zu sehen sind und mit den in Ihrem Profil angegebenen Daten übereinstimmen. Das Dokument sollte nicht später als 3 Monate ausgegeben werden. Die 4 Kanten des Dokuments sollten auf dem Foto sichtbar sein.
                                            <br>
                                        ...
                                        <form action="{{LaravelLocalization::localizeURL('/resident-document-upload')}}" method="post" class="dropzone" id="DropZoneFiddle" enctype="multipart/form-data">
                                          ...
                                          <br>
                                          <small>Sie können Bilder in JPG-, JPEG-, PNG-, GIF-, TIF-, TIFF-, PDF-Formaten hochladen, die nicht größer als 2 MB sind</small>
                                          <br>
