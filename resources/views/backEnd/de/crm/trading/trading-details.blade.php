...
<div id="content" class="bg-container">
                ...
                <div class="col-md-8">
                  ...
                  <div class="col-md-12">
                    <div class="fund-button clearfix">
                      <div class="col-md-4">
                       <a href="/deposit-funds?ac={{$accounts->account_no}}" class="title-button"><button>Gelder Einzahlen</button></a>
                      </div>
                      <div class="col-md-4">
                       <a href="/internal-transfer?ac={{$accounts->account_no}}"><button>Interner transfer</button></a>
                      </div>
                      <div class="col-md-4">
                        <a href="/change-mt4-password?ac={{$accounts->account_no}}"><button>Passwort ändern</button></a>
                      </div>
              ...
              <div class="card height">
                <table class="table" id="myTable">
                        <tbody>
                            ...
                            <tr>
                                <td class="left">USDHebel</td>
                                <td class="left" id="leverage_show">1 : {{$accounts->LEVERAGE}}</td>
                            </tr>
                            <tr>
                                <td class="left">Kommission</td>
                                <td class="left" id=""></td>
                            </tr>
                            <tr>
                                <td class="left">Mindesteinzahlung</td>
                                <td class="left" id=""></td>
                            </tr>
                    ...
                    <div class="card-block">
                        ...
                        <div class="nav-tabs-custom">
                                            <ul class="nav nav-tabs" style="margin-top: 12px">
                                                <li class="nav-item">
                                                    <a href="#tab_2" class="nav-link active" data-toggle="tab">Live-Handel    </a>
                                                </li>
                                                
                                                <li class="nav-item">
                                                    <a href="#tab_4" class="nav-link" data-toggle="tab">Verlauf</a>
                                                </li>
  ...
  if(count($trades)>0){
    ...
    <tr>
      ...
      echo  '<tr><td colspan="11" style="text-align: left;"><strong>Balance: '.$accounts->BALANCE.', Kredit: '.$accounts->CREDIT.', Eigenkapital: '.$accounts->EQUITY.', Freie Marge: '.$accounts->MARGIN_FREE.'</strong></td><td colspan="1"></td></tr>';
}
      else{
            ...
            <div class="row">
              <div class="col-sm-12">
                <table class="display table table-bordered  dataTable no-footer" id="tradingHistory" role="grid" aria-describedby="commission_table1_info" style="width: 100%;" width="100%">
                    ...
                    <div class="col-md-3 custom-date">
                      <button type="button" id="dateSearch" class="btn btn-success m-t-33 check-button">überprüfen</button>
                    </div>
