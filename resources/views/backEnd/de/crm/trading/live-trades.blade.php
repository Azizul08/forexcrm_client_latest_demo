              ...
              <div class="col-sm-12">
                <table class="display table table-bordered nowrap  no-footer" id="commission_table1" role="grid" aria-describedby="commission_table1_info" style="width: 100%;" width="100%">
                                 <thead style="white-space:nowrap;">
                                    <tr role="row">
                                      <th class="sorting_asc" rowspan="1" colspan="1" style="width: 49.5px;" aria-label="SR No."><span>Konto</span></th>
                                      <th class="sorting" tabindex="0" aria-controls="commission_table1" rowspan="1" colspan="1" style="width: 112.5px;" aria-label="Name(IB Code): activate to sort column ascending">Ticket</th>
                                      <th class="sorting" tabindex="0" aria-controls="commission_table1" rowspan="1" colspan="1" style="width: 88.5px;" aria-label="Account No.: activate to sort column ascending">Zeit</th>
                                      <th class="sorting" tabindex="0" aria-controls="commission_table1" rowspan="1" colspan="1" style="width: 102.5px;" aria-label="Account Type.: activate to sort column ascending">Typ</th>
                                      <th class="sorting" tabindex="0" aria-controls="commission_table1" rowspan="1" colspan="1" style="width: 56.5px;" aria-label="Volume: activate to sort column ascending">Anteile</th>
                                      <th class="sorting" tabindex="0" aria-controls="commission_table1" rowspan="1" colspan="1" style="width: 89.5px;" aria-label="Commission: activate to sort column ascending">Symbol</th>
                                      <th class="sorting" tabindex="0" aria-controls="commission_table1" rowspan="1" colspan="1" style="width: 59.5px;" aria-label="Country: activate to sort column ascending">Eröffnungs Preis</th>
                                      ...
                                      <th class="sorting" tabindex="0" aria-controls="commission_table1" rowspan="1" colspan="1" style="width: 72.5px;" aria-label="Reg. Date: activate to sort column ascending"><span>Echtzeit Preis</span></th>
                                      <th class="sorting" tabindex="0" aria-controls="commission_table1" rowspan="1" colspan="1" style="width: 72.5px;" aria-label="Reg. Date: activate to sort column ascending"><span>Kommission</span></th>
                                      <th class="sorting" tabindex="0" aria-controls="commission_table1" rowspan="1" colspan="1" style="width: 72.5px;" aria-label="Reg. Date: activate to sort column ascending"><span>Tausch</span></th>
                                      ...
                                      <th class="sorting" tabindex="0" aria-controls="commission_table1" rowspan="1" colspan="1" style="width: 72.5px;" aria-label="Reg. Date: activate to sort column ascending"><span>Eigenkapital</span></th>
                                    </tr>
                               </thead>
