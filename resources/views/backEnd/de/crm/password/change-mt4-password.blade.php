...
@section('title', 'MT4 Passwort Ändern')
            ...
            <div class="card">
                ...
                <div class="card-block m-t-35">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="up-barcurb">
                                <li class="first-li selected"> 1. Ändern Sie das MT4-Passwort</li>
                                <li class="second-li"> 2. Bestätige den Code</li>
                            </ul>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card select-account" style="height: auto">
                                <div class="select-account-body">
                                    <h4>Ändern Sie das MT4 Passwort</h4>
                                        ...
                                        <div class="form-group">
                                            <div class="span3 " style="margin-top: 5px;"><label class="control-label">Wählen Sie Konto:</label></div>
                                            <div class="span4 form-group">
                                                <select name="account_no" class="form-control" id="account_no" >
                                                    <option value="" disabled="disabled" selected="selected">Wählen Sie Konto</option>
                           ...
                           <div class="col-md-6">
                            <div class="card select-account" style="height: auto">
                                <div class="select-account-body">
                                    <h4>Ändern Sie das Passwort für den Investor</h4>
                                    ...
                                    <div class="form-group">
                                      <label for="investor_password">Passwort:</label>
                                    ...
                                    <div class="form-group">
                                        <label for="cinvestor_password">Passwort bestätigen:</label>
                                    ...
                                    <div class="control-group">
                                       <div class="span4"></div>
                                       <div class="span4 form-group">
                                           <input type="submit" id="submit1" class="btn btn-primary" value="Ändern" name="submit1"> 
                                           <!--<button type="submit" class="btn">Continue</button>-->
...
<script type="text/javascript">
    $(function(){
        ...
        form.validate({
            ...
            messages : {
                account_no : {
                    required: "Bitte wählen Sie ein Konto",
                },
                password : {
                    required: "Passwort wird benötigt",
                },
                c_password : {
                    required: "Passen Sie Ihr Passwort an",
                },
            }
        });
        form1.validate({
