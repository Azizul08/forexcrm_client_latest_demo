...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="{{asset('css/dashboard-color.css')}}" />
...
<div id="wrap">
        ...
        <div id="left" style="background:rgb(61, 65, 68) none repeat scroll 0% 0%;padding-top: 50px;">
            <div class="menu_scroll">
                    ...
                    <a class="navbar-brand float-left text-center" href="/dashboard">
                        ...
                        <div class="user-wrapper bg-dark">
                            <a class="user-link" href="/profile" style="top:4px">
                                ...
                                src="{{session('profile_pic')}}"><p class="user-info menu_hide">Welcome {{session('fname')}} <br>ID : {{session('id')}}</p>
                            </a>
                        </div>
                ...
                <ul id="menu">
                    ...
                    <li {!! (Request::is('*/profile') || Request::is('*/update-profile')|| Request::is('*/change-password')|| Request::is('*/verify-profile')|| Request::is('*/bank-information')|| Request::is('*/bank-information') || Request::is('*/identity-documents-details') || Request::is('*/resident-documents-details')? 'class="active dropdown_menu list-active"':" dropdown_menu list-active") !!}>
                        <a href="javascript:;">
                            <i class="fa fa-user-plus"  style=""></i>
                            <span class="link-title menu_hide">&nbsp;Mein Profil</span>
                        ...
                        <ul>
                           <li {!! (Request::is('*/profile')? 'class="active"':"") !!}>
                            <a href="/profile">
                                ...
                                <span class="link-title ">&nbsp;Profil anzeigen</span>
                            </a>
                        ...
                        <li {!! (Request::is('*/change-password')? 'class="active"':"") !!}>
                            <a href="/change-password">
                                ...
                                <span class="link-title">&nbsp;Passwort ändern</span>
                            </a>

                        </li>
                        <li {!! (Request::is('*/verify-profile') || Request::is('*/identity-documents-details') || Request::is('*/resident-documents-details')? 'class="active"':"") !!}>
                            <a href="/verify-profile">
                                <i class="fa fa-check-square-o" style=""></i>
                                <span class="link-title">&nbsp;Profil verifizieren</span>
                            </a>
                         ...
                         <li {!! (Request::is('*/bank-information')? 'class="active"':"") !!}>
                            <a href="/bank-information">
                                ...
                                <span class="link-title">&nbsp;Bank Informationen</span>
                            </a>
                ...
                <li {!! (Request::is('*/trading_account-*')? 'class="active dropdown_menu list-active"':" dropdown_menu list-active") !!}>
                    <a href="javascript:;">
                        <i class="fa fa-th-large" style=""></i>
                        <span class="link-title menu_hide">&nbsp;Live Konten</span>
                        <span class="fa arrow menu_hide"></span>
                    </a>
    ...
    <li {!! (Request::is('*/trading_account-'.$account->account_no) || Request::is(app()->getLocale().'/trading_account-'.$account->account_no)? 'class="active tr-ac-active"':'class="tr-ac-active"') !!}>
  ...
  @endforeach    
                ...
                <li {!! (Request::is('*/all-trading-accounts') || Request::is('*/open-new-account')|| Request::is('*/live-trades')|| Request::is('*/change-leverage')|| Request::is('*/change-mt4-password')|| Request::is('*/open-trading-account')|| Request::is('*/open-demo-account')? 'class="active dropdown_menu list-active"':" dropdown_menu list-active") !!}>
                    <a href="javascript:;">
                        <i class="fa fa-line-chart"  style=""></i>
                        <span class="link-title menu_hide">&nbsp;Handel</span>
                        <span class="fa arrow menu_hide"></span>
                    </a>
                    <ul>
                       <li {!! (Request::is('*/all-trading-accounts')? 'class="active"':"") !!}>
                        <a href="/all-trading-accounts">
                            ...
                            <span class="link-title ">&nbsp;Meine MT4-Konten</span>
                        </a>
                    </li>
                    <li {!! (Request::is('*/open-new-account')|| Request::is('*/open-trading-account')|| Request::is('*/open-demo-account')? 'class="active"':"") !!}>
                        <a href="/open-new-account">
                            <i class="fa fa-smile-o" style=""></i>
                            <span class="link-title ">&nbsp;Handelskonto eröffnen</span>
                        </a>
                    </li>
                    ...
                    <li {!! (Request::is('*/change-mt4-password')? 'class="active"':"") !!}>
                        <a href="/change-mt4-password">
                            ...
                            <span class="link-title ">&nbsp;MT4-Passwort wechseln</span>
                        </a>
                    </li>
            ...
            <li {!! (Request::is('*/deposit-funds') || Request::is('*/internal-transfer')|| Request::is('*/withdraw-funds')|| Request::is('*/transaction-history') || Request::is('*/voguepay_deposit')||Request::is('*/bank-transfer-funds')||Request::is('*/skrill_deposit')||Request::is('*/neteller_deposit')||Request::is('*/perfect_money_deposit')||Request::is('*/bank-withdraw-funds')||Request::is('*/skrill_withdraw')||Request::is('*/neteller_withdraw')||Request::is('*/okpay_withdraw')||Request::is('*/perfect_money_withdraw')? 'class="active dropdown_menu list-active"':" dropdown_menu list-active") !!}>
                <a href="javascript:;">
                    <i class="fa fa-money"  style=""></i>
                    <span class="link-title menu_hide">&nbsp;Finanzierung</span>
                    <span class="fa arrow menu_hide"></span>
                </a>
                <ul>

                    <li {!! (Request::is('*/deposit-funds') || Request::is('*/voguepay_deposit')||Request::is('*/skrill_deposit')||Request::is('*/neteller_deposit')||Request::is('*/perfect_money_deposit')||Request::is('*/bank-transfer-funds')? 'class="active"':"") !!}>
                        <a href="/deposit-funds">
                            <i class="fa fa-credit-card" style=""></i>
                            <span class="link-title ">&nbsp;Gelder einzahlen</span>
                        </a>
                    </li> 
                    <li {!! (Request::is('*/internal-transfer')? 'class="active"':"") !!}>
                        <a href="/internal-transfer">
                            <i class="fa fa-exchange" style=""></i>
                            <span class="link-title ">&nbsp;Interner Transfer</span>
                        </a>
                    </li>
                    

                    <li {!! (Request::is('*/withdraw-funds')||Request::is('*/bank-withdraw-funds')||Request::is('*/skrill_withdraw')||Request::is('*/neteller_withdraw')||Request::is('*/okpay_withdraw')||Request::is('*/perfect_money_withdraw')? 'class="active"':"") !!}>
                        <a href="/withdraw-funds">
                            <i class="fa fa-money" style=""></i>
                            <span class="link-title ">&nbsp;Gelder abheben</span>
                        </a>
                    </li>  
                    ...
                    <li {!! (Request::is('*/transaction-history')? 'class="active"':"") !!}>
                        <a href="/transaction-history">
                            ...
                            <span class="link-title ">&nbsp;Transaktionsverlauf</span>
                        </a>
                    </li>           
            ...
            <li {!! (Request::is('*/open-ticket') || Request::is('*/my-tickets')? 'class="active dropdown_menu list-active"':" dropdown_menu list-active") !!}>
                <a href="javascript:;">
                    <i class="fa fa-ticket"  style=""></i>
                    <span class="link-title menu_hide">&nbsp;Fahrkarte</span>
                    <span class="fa arrow menu_hide"></span>
                </a>
                <ul>
                    ...
                    <a href="/open-ticket" >
                            <i class="fa fa-envelope-open" style=""></i>
                            <span class="link-title">&nbsp;Ticket eröffnen</span>
                    </a>
                    </li>
                    <li {!! (Request::is('*/my-tickets')? 'class="active"':"") !!}>
                    <a href="/my-tickets" >
                            <i class="fa fa-list-ul" style=""></i>
                            <span class="link-title ">&nbsp;Meine Tickets</span>
                    </a>
                    </li> 
            ...
            <a href="/contest" >
                    ...
                    <span class="link-title menu_hide">&nbsp;Wettkampf</span>
                </a>
            </li>
            ...
            <a href="/mam-pamm-platform" >
                    ...
                    <span class="link-title menu_hide">&nbsp;MAM & PAMM Plattform</span>
                </a>
            </li>
            ...
            <a href="/download-platforms" >
                    ...
                    <span class="link-title menu_hide">&nbsp;Plattform herunterladen</span>
                </a>
            </li>
            ...
            <a href="#">
                    ...
                    <span class="link-title menu_hide">&nbsp;Kontaktieren Sie uns</span>
                </a>
            </li>  -->
            <li {!! (Request::is('*/#')? 'class="active"':"") !!}>
...
<script type="text/javascript">
    $(function(){
            ...
            if ($(window).width()<768) {
                    ...
                    $('.panel-button').css({'padding':'0'});
                    $('.panel-button a').css({'padding':'2px','border':'none'});
...
<script>
 {{--  $(function () {
        ...
        if($('.tr-ac-active').hasClass('active')){
            $('.tr-ac-parent-active').addClass('active dropdown_menu list-active').removeClass('tr-ac-parent-active');
