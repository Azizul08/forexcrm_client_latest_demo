                ...
                <div class="col-xs-6 column">
                  <div class="text-center header-right-content">
                    <?php if (Request::is('login') || Request::is(app()->getLocale().'/login')): ?>
                      <div class="button-sign" style="width: 160px">
                        <p>Konto eröffnen!<span><a href="/live-account-register">Anmleden</a></span></p>
                    ...
                    <?php if (Request::is('live-account-register') || Request::is(app()->getLocale().'/live-account-register')): ?>
                      <div class="button-sign" style="width: 160px">
                        <p>Konto eröffnen!<span><a href="/login">Einloggen</a></span></p>
