          ...
          <div class="col-md-12 col-xs-12  form-div-height">
            ...
            <div class="col-md-8 col-md-push-5 col-xs-12  col-sm-8 text-center">
              ...
              <form id="myform" method="post" action="{{LaravelLocalization::localizeURL('/register')}}">
                ...
                @endif
                <fieldset id="x">
                  <h2 class="fs-title">Registrieren</h2>
                  <hr>
                  ...
                  <div class="row">
                    ...
                    <div class="row">
                      ...
                      <label class="control-label" for="input" style="">Bestätigen Sie das Passwort</label><i class="bar"></i>
                      </div>
                      </div>
                    </div>
                    <div class="row">
...
//     }, "year required");
    ...
    form.validate({
      ...
      messages: {
        ...
        deposit: {
          require: "Bitte Betrag eingeben",
          minlength: "Bitte geben Sie den gültigen Betrag ein"
        },

        phone: {
          required:"Telefonnummer ist erforderlich",
          min: "Geben Sie eine gültige Telefonnummer ein"
        },
