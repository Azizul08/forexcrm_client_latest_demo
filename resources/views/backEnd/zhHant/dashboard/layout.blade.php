...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('css/flag-icon.min.css')}}"> @yield('page-level-css')
                ...
                <nav class="navbar navbar-static-top">
                    <div class="container-fluid m-0 navbar-flex" style="">
                        ...
                        <div class="topnav dropdown-menu-right float-right hidden-xs hidden-sm" style="float: right; width: 100%;margin-top: 15px;">
                            <div class="menu-ul">
                                <ul style="">
                                    <li><a href="{{$general_info->live_chat_link}}">在線聊天</a></li>
                                    ...
                                    <div class="show-language-menu">
                                        @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties) @if (LaravelLocalization::getCurrentLocale()
                                        == $localeCode)
                                        <a href="#">
                                        @if($localeCode=="en")
                    ...
                    <div class="menu_scroll">
                        <div class="left_media">
                            <div class="media user-media bg-dark dker">
                                ...
                                <div class="user-wrapper bg-dark">
                                    ...
                                    <p class="user-info menu_hide">歡迎光臨 {{session('fname')}} <br>ID :
                                        {{session('id')}}</p>
                                </a>
                                </div>
                        ...
                        <ul id="menu">
                            <li {!! (Request::is( '*/dashboard')? 'class="active"' : "") !!}>
                                ...
                                <span class="link-title menu_hide">&nbsp;儀表板</span>
                            </a>
                            </li>

                            <li {!! (Request::is( '*/profile') || Request::is( '*/update-profile')|| Request::is( '*/change-password')|| Request::is(
                                '*/verify-profile')|| Request::is( '*/bank-information')|| Request::is( '*/bank-information') || Request::is(
                                '*/identity-documents-details') || Request::is( '*/resident-documents-details')?
                                'class="active dropdown_menu list-active"' : " dropdown_menu list-active") !!}>
                                <a href="javascript:;">
                                <i class="fa fa-user-plus" style=""></i>
                                <span class="link-title menu_hide">&nbsp; 我的資料</span>
                                ...
                                <ul>
                                    <li {!! (Request::is( '*/profile')? 'class="active"' : "") !!}>
                                        ...
                                        <span class="link-title ">&nbsp;查看個人資料</span>
                                    </a>
                                    ...
                                    <li {!! (Request::is( '*/change-password')? 'class="active"' : "") !!}>
                                        ...
                                        <span class="link-title">&nbsp;修改密碼</span>
                                    </a>

                                    </li>
                                    <li {!! (Request::is( '*/verify-profile') || Request::is( '*/identity-documents-details') || Request::is(
                                        '*/resident-documents-details')? 'class="active"' : "") !!}>
                                        <a href="/verify-profile">
                                        <i class="fa fa-check-square-o" style=""></i>
                                        <span class="link-title">&nbsp;驗證配置文件</span>
                                    </a>
                                    ...
                                    <li {!! (Request::is( '*/bank-information')? 'class="active"' : "") !!}>
                                        ...
                                        <span class="link-title">&nbsp;銀行信息</span>
                                    </a>
                            ...
                            dropdown_menu list-active") !!}>
                                ...
                                <span class="link-title menu_hide">&nbsp; 流水賬</span>
                                <span class="fa arrow menu_hide"></span>
                            </a>
                            ...
                            <li {!! (Request::is( '*/all-trading-accounts') || Request::is( '*/open-new-account')|| Request::is( '*/live-trades')|| Request::is(
                                '*/change-leverage')|| Request::is( '*/change-mt4-password')|| Request::is( '*/open-trading-account')|| Request::is(
                                '*/open-demo-account')? 'class="active dropdown_menu list-active"' : " dropdown_menu list-active") !!}>
                                <a href="javascript:;">
                                ...
                                <ul>
                                    <li {!! (Request::is( '*/all-trading-accounts')? 'class="active"' : "") !!}>
                                        ...
                                        <span class="link-title ">&nbsp;我的MT4賬戶</span>
                                    </a>
                                    </li>
                                    <li {!! (Request::is( '*/open-new-account')|| Request::is( '*/open-trading-account')|| Request::is( '*/open-demo-account')?
                                        'class="active"' : "") !!}>
                                        <a href="/open-new-account">
                                        <i class="fa fa-smile-o" style=""></i>
                                        <span class="link-title ">&nbsp;打開新賬戶</span>
                                    </a>
                                    </li>
                        ...
                        <a href="/open-trading-account">
                            ...
                            <span class="link-title ">&nbsp;Open Trading Account</span>
                                    ...
                                    <li {!! (Request::is( '*/change-mt4-password')? 'class="active"' : "") !!}>
                                        ...
                                        <span class="link-title ">&nbsp;修改MT4密碼</span>
                                    </a>
                                    </li>
                            ...
                            <li {!! (Request::is( '*/deposit-funds') || Request::is( '*/internal-transfer')|| Request::is( '*/withdraw-funds')|| Request::is(
                                '*/transaction-history') || Request::is( '*/voguepay_deposit')||Request::is( '*/bank-transfer-funds')||Request::is(
                                '*/skrill_deposit')||Request::is( '*/neteller_deposit')||Request::is( '*/perfect_money_deposit')||Request::is(
                                '*/bank-withdraw-funds')||Request::is( '*/skrill_withdraw')||Request::is( '*/neteller_withdraw')||Request::is(
                                '*/okpay_withdraw')||Request::is( '*/perfect_money_withdraw')? 'class="active dropdown_menu list-active"' :
                                " dropdown_menu list-active") !!}>
                                <a href="javascript:;">
                                <i class="fa fa-money" style=""></i>
                                <span class="link-title menu_hide">&nbsp; 資金</span>
                                <span class="fa arrow menu_hide"></span>
                            </a>
                                <ul>

                                    <li {!! (Request::is( '*/deposit-funds') || Request::is( '*/voguepay_deposit')||Request::is( '*/skrill_deposit')||Request::is(
                                        '*/neteller_deposit')||Request::is( '*/perfect_money_deposit')||Request::is( '*/bank-transfer-funds')?
                                        'class="active"' : "") !!}>
                                        <a href="/deposit-funds">
                                        <i class="fa fa-credit-card" style=""></i>
                                        <span class="link-title ">&nbsp;存款資金</span>
                                    </a>
                                    </li>
                                    <li {!! (Request::is( '*/internal-transfer')? 'class="active"' : "") !!}>
                                        <a href="/internal-transfer">
                                        <i class="fa fa-exchange" style=""></i>
                                        <span class="link-title ">&nbsp;內部轉賬</span>
                                    </a>
                                    </li>

                                    <li {!! (Request::is( '*/withdraw-funds')||Request::is( '*/bank-withdraw-funds')||Request::is( '*/skrill_withdraw')||Request::is(
                                        '*/neteller_withdraw')||Request::is( '*/okpay_withdraw')||Request::is( '*/perfect_money_withdraw')?
                                        'class="active"' : "") !!}>
                                        <a href="/withdraw-funds">
                                        <i class="fa fa-money" style=""></i>
                                        <span class="link-title ">&nbsp;取款</span>
                                    </a>
                                    </li>
                                    ...
                                    <li {!! (Request::is( '*/transaction-history')? 'class="active"' : "") !!}>
                                        ...
                                        <span class="link-title ">&nbsp;交易記錄</span>
                                    </a>
                                    </li>
                            ...
                            <li {!! (Request::is( '*/open-ticket') || Request::is( '*/my-tickets')? 'class="active dropdown_menu list-active"' :
                                " dropdown_menu list-active") !!}>
                                <a href="javascript:;">
                                <i class="fa fa-ticket" style=""></i>
                                <span class="link-title menu_hide">&nbsp; 請求單</span>
                                <span class="fa arrow menu_hide"></span>
                            </a>
                                <ul>
                                    ...
                                    <li {!! (Request::is( '*/open-ticket')? 'class="active"' : "") !!}>
                                        <a href="/open-ticket">
                                        <i class="fa fa-envelope-open" style=""></i>
                                        <span class="link-title">&nbsp;開票</span>
                                    </a>
                                    </li>
                                    <li {!! (Request::is( '*/my-tickets')? 'class="active"' : "") !!}>
                                        <a href="/my-tickets">
                                        <i class="fa fa-list-ul" style=""></i>
                                        <span class="link-title ">&nbsp;我的門票</span>
                                    </a>
                                    </li>
                            ...
                            <li {!! (Request::is( '*/download-platforms')? 'class="active"' : "") !!}>
                                ...
                                <span class="link-title menu_hide">&nbsp;下載平台</span>
                            </a>
                            </li>
            ...
            <a href="#">
                    ...
                    <span class="link-title menu_hide">&nbsp;Contact Us</span>
                            ...
                            <li {!! (Request::is( '*/#')? 'class="active"' : "") !!}>
                                ...
                                <span class="link-title menu_hide">&nbsp;在線支持</span>
                            </a>
                            </li>
                            <li {!! (Request::is( '*/faqs')? 'class="active"' : "") !!}>
                                <a href="/faqs">
                                <i class="fa fa-question-circle" style=""></i>
                                <span class="link-title menu_hide">&nbsp;常見問題</span>
                            </a>
                            </li>
                        </ul>
                    </div>
