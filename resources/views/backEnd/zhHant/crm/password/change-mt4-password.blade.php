                ...
                <div class="card-block m-t-35">
                   {{--  <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="up-barcurb">
                                <li class="first-li selected"> 1. 選擇您的密碼</li>
                                <li class="second-li"> 2. 確認代碼 </li>
                            </ul>
                        </div>
                    </div>
                    <div class="row">
                                ...
                                <div class="select-account-body">
                                    <h4>更改 MT4 密碼</h4>
                                        ...
                                        <div class="form-group">
                                            <div class="span3 " style="margin-top: 5px;"><label class="control-label">選擇帳戶:</label></div>
                                            <div class="span4 form-group">
                                                <select name="account_no" class="form-control" id="account_no" >
                                                    <option value="" disabled="disabled" selected="selected">選擇帳戶</option>
                                    ...
                                    <div class="form-group">
                                        <label for="confirmPassword">確認 密碼:</label>
                           ...
                           <div class="col-md-6">
                            <div class="card select-account" style="height: auto">
                                <div class="select-account-body">
                                    ...
                                    <div class="form-group">
                                      <label for="investor_password">密碼:</label>
                                    ...
                                    <div class="form-group">
                                        <label for="cinvestor_password">確認 密碼:</label>
