...
<div id="content" class="bg-container">
    ...
    <div class="outer">
        <div class="inner bg-container">
            ...
            <!--top section widgets-->
           <p style="margin-top:50px;line-height: 50px;font-size: 32px;"><span style="color:green;">恭喜 </span> 您的交易帳戶詳情已發送到 <span style="font-weight: bold;">{{session('login_email')}}</span>.</p>
