                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="dropFile-notice">
                                            ...
                                            <br>
                                           為了核實您的居住地址，請上傳照片或掃描以下檔案之一：
                                            <br>
                                            <ul style="list-style: inside;padding: 0">
                                                <li>公用事業服務費收據（水電單）</li>
                                                <li>銀行結單</li>
                                                <li>帶住址的本地護照的第頁（如果此處所述地址與當前地址匹配，並且您已上傳本地護照的第一頁作為您的身份證明）。</li>
                                            </ul>
                                            
                                            我們接受彩色高解析度照片或掃描檔案副本，其中您的全名和地址清晰可見，並與您的個人資料中訓示的數據匹配。該檔案應不遲於3個月前發出。檔案的4個邊緣應在照片上可見。
                                            <br>
                                        ...
                                        <form action="{{LaravelLocalization::localizeURL('/resident-document-upload')}}" method="post" class="dropzone" id="DropZoneFiddle" enctype="multipart/form-data">
                                          ...
                                          <br>
                                          <span style="font-size: 25px">將掃描副本拖到此處或按一下以上載</span>
                                          <br>
                                          <small>您可以上傳JPG、JPEG、PNG、GIF、TIF、TIFF、PDF格式的圖片，圖片大小不超過2 M B。</small>
                                          <br>
