                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="panel-button">
                            <a href="/verify-profile">配置文件認證</a>
                            <span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span>
                            <a href="/open-trading-account">打開交易說明 </a>
                            <span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span>
                            <a href="/deposit-funds">存款基金 </a>
                            <span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span>
            ...
            <div class="row sales_section">
                <div class="col-xl-3 col-sm-6 col-12">
                    <div class="card p-d-15">
                        ...
                        <div>
                            <h5 class="sales_orders text-right m-t-5">關閉訂單</h5>
                            ...
                            <!-- <p class="sales_text">Total Closed Orders: {{$order}}
                                ...
                                <p class="sales_text">總成交量: {{$volume}}</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="live-account m-b-20" style="">
                               <div class="" style="background: #fdfdfd;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <ul class="dropdown-menu form-dropdown" aria-labelledby="dropdownMenu1">
                                                        <li><a href="/deposit-funds?ac={{$account->account_no}}">存款資金</a></li>
                                                        <li><a href="/withdraw-funds?ac={{$account->account_no}}">取款</a></li>
                                                        <li><a href="/internal-transfer?ac={{$account->account_no}}">內部轉賬</a></li>
                                                        <li><a href="/change-leverage?ac={{$account->account_no}}">變更槓桿</a></li>
                                                        <li><a href="/change-mt4-password?ac={{$account->account_no}}">更改交易密碼</a></li>
                                                        <li><a href="/trading_account-{{$account->account_no}}">帳戶詳細資料</a></li>
                                ...
                                <div class="form-button m-t-5">
                                    ...
                                    <a href="/all-trading-accounts"><button>查看所有帳戶</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="frt-td"><img class="hidden-xs transaction-img" src="/img/logo-1531195160.png" alt="">
                                            <p><a href="/bank-transfer-funds">銀行轉帳</a></p></td>
                                        ...
                                        <tr>
                                            ...
                                            <tr>
                                                <td class="frt-td"><img class="hidden-xs transaction-img" src="/img/upaycard.png" alt="">
                                                    ...
                                                    <td class="last-td"><a href="/upaycard-deposit"><button>存款</button></a></td>
                                                </tr>
                                                <tr>
                            ...
                            <div class="col-lg-12">
                                <div class="card m-t-35">
                                    <div class="card-header bg-white">
                                        ...
                                        <a style="text-decoration: underline;" class="pull-right" href="/live-trades">顯示全部</a>
                                    </div>
