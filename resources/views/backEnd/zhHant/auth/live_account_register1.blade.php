          ...
          <div class="col-md-12 col-xs-12  form-div-height">
            ...
            <div class="col-md-8 col-md-push-5 col-xs-12  col-sm-8 text-center">
              ...
              <form id="myform" method="post" action="{{LaravelLocalization::localizeURL('/live-account-register')}}">
                ...
                <ul id="progressbar">
                  <li class="active"><span style="color: #777">個人信息</span></li>
                  <li><span style="color: #777">個人信息</span></li>
                  <li><span style="color: #777">賬戶信息</span></li>
                  <li><span style="color: #777">細節</span></li>
                </ul>

                <fieldset id="x">
                  <h2 class="fs-title">個人信息</h2>
                  <hr>
                  ...
                  <div class="row">
                    ...
                    <div class="form-group">
                      ...
                      <label class="control-label" for="input">名稱</label><i class="bar"></i>
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-md-8 col-md-push-2">
                    ...
                    <div class="form-group">
                      ...
                      <label class="control-label" for="input">密碼</label><i class="bar"></i>
                    </div>
                  </div>
                  <div class="col-md-8 col-md-push-2">
                    ...
                    <div class="form-group">
                      ...
                      <label class="control-label" for="input">確認密碼</label><i class="bar"></i>
                    </div>
                  </div>
                  ...
                  <fieldset id="a">
                    ...
                    <div class="col-md-6 clearfix">
                          ...
                          <div class="wrap">
                            ...
                            <div class="select">
                              <select class="select-text" id="country" name="country" style="color: #777" required>
                                <option code="" selected="selected" disabled="disabled" style="color: #777">選擇國家</option>
                              ...
                              <small class="label-style">國家</small>
                      ...
                      <div class="wrap">
                        ...
                        <div class="select">
                          ...
                          <span class="select-highlight"></span>
                          <span class="select-bar"></span>
                          <small class="label-style">選擇州</small>
                        </div>
                        <!--Select with pure css-->
                    ...
                    <div class="col-md-6 clearfix">
                      ...
                      <div class="wrap">
                        ...
                        <div class="select" style="margin-top: -7%">
                          ...
                          <span class="select-highlight"></span>
                          <span class="select-bar"></span>
                          <small class="label-style">選擇城市</small>
                        </div>
                        <!--Select with pure css-->
                    ...
                    <div class="col-md-6 clearfix">
                      ...
                      <div class="form-group">
                        ...
                        <label class="control-label" for="input">郵政編碼</label><i class="bar"></i>
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        <label class="control-label" for="input">電話</label><i class="bar"></i>
                      </div>
                    </div>
                    <!-- <div class="col-md-6">
                      <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <label class="control-label" for="input">出生日期</label><i class="bar"></i>
                      </div>
                      
                    </div>
                  </div>
                </div>
                <input type="button" name="previous" class="previous action-button center-block" value="返回" />
                <input type="button" name="next1" class="next1 action-button center-block" value="下一步" id="next1" />
                
              </fieldset>

              <fieldset id="y">
                <h2 class="fs-title">賬戶信息</h2>
                <hr>
                    ...
                    <div class="col-md-8 col-md-push-2">
                      <div class="wrap">
                        ...
                        <div class="select">
                          ...
                          <span class="select-highlight"></span>
                          <span class="select-bar"></span>
                          <small class="label-style">賬戶類型</small>
                      ...
                      <div class="wrap">
                        ...
                        <div class="select">
                          <select class="select-text" name="leverage" id="leverage" style="color: #777" required>
                            <option value="" disabled selected>選擇槓桿</option>
                            @foreach($leverage as $lev)
                            <option value="{{$lev->leverage}}">{{$lev->leverage}}:1</option>
                          ...
                          <span class="select-highlight"></span>
                          <span class="select-bar"></span>
                          <small class="label-style">槓桿</small>
                  ...
                  <div class="row">
                    <div class="col-md-8 col-md-push-2">
                      <div class="form-group">
                        ...
                        <label class="control-label" for="input">交易密碼</label><i class="bar"></i>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-8 col-md-push-2">
                      <div class="form-group">
                        ...
                        <label class="control-label" for="input" style="margin-top: 2%">確認交易密碼</label><i class="bar"></i>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-8 col-md-push-2">
                      <div class="form-group">
                        ...
                        <span class ='message'></span>
                        <label class="control-label" for="input">投資者密碼</label><i class="bar"></i>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-8 col-md-push-2">
                      <div class="form-group">
                        ...
                        <label class="control-label" for="input" style="margin-top: 2%">確認投資者密碼</label><i class="bar"></i>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="col-md-8 col-md-push-2">
                    ...
                    <div class="form-group">
                      ...
                      <label class="control-label checkbox-inline small-label" for="input" style="">同意條款和條件</label><!-- <i class="bar"></i> -->
                    </div>
                  </div>
                ...
                <input type="button" name="previous" class="previous action-button center-block" value="上一頁" />
                <input type="button" name="next2" class="next action-button center-block" value="下一頁" id="next2" />
              </fieldset>

              <fieldset id="z">
                <h2 class="fs-title">細節</h2>
                <hr>
  ...
  $(document).ready(function(){
    ...
    $('#passwordField, #c_password').on('keyup', function () {
      ...
      if ($('#passwordField').val() == $('#c_password').val()) {
        $('#message').html('密碼匹配').css('color', 'green');
      } 
      else 
        $('#message').html('輸入相同的密碼').css('color', 'red');
    ...
    $('#passwordField1, #c_investor_password').on('keyup', function () {
      ...
      if ($('#passwordField1').val() == $('#c_investor_password').val()) {
        $('#message1').html('密碼匹配').css('color', 'green');
      } 
      else 
        $('#message1').html('輸入相同的密碼').css('color', 'red');
...
$("#next2").click(function(){
  ...
  if ( o_pass!= s_pass) {
    ...
    $('#message').html('密碼不匹配').css('color', 'red');
    e.preventDefault();
  }
  else{
    ...
    if (flag1 == 0) {
      $('.message').html('檢查條件').css('color', 'red');
      e.preventDefault();
    }
    if (flag2 == 0) {
      $('.message').html('檢查條件').css('color', 'red');
  ...
  if ( o_pass1!= s_pass1) {
    ...
    $('#message1').html('密碼不匹配').css('color', 'red');
    e.preventDefault();
  }
  else{
    ...
    if (flag6 == 0) {
      $('.message1').html('檢查條件').css('color', 'red');
      e.preventDefault();
    }
    if (flag7 == 0) {
      $('.message1').html('檢查條件').css('color', 'red');
