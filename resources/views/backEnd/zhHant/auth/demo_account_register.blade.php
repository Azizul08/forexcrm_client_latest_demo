                ...
                <div class="row">
                  ...
                  <div class="col-md-10 col-md-push-1">
                    ...
                    <div class="form-group">
                      ...
                      <label class="control-label" for="input">電子郵箱</label><i class="bar"></i>
                    </div>
                ...
                <div class="row" >
                  ...
                  <div class="col-md-5 col-md-push-1">
                    ...
                    <div class="form-group" style="margin-top: 18px" >
                      ...
                      <label class="control-label" for="input" style="margin-top: 11px">電話</label><i class="bar"></i>
                    </div>
                  </div>
                  ...
                  <div class="col-md-5 col-md-push-1">
                    <div class="wrap">
                      ...
                      <div class="select">
                        ...
                        <span class="select-highlight"></span>
                        <span class="select-bar"></span>
                        <small class="label-style">帳戶類型</small>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-5 col-md-push-1">
                      <div class="form-group" class="small-device-style">
                        ...
                        <label class="control-label" for="input" style="">確認交易密碼</label><i class="bar"></i>
                      </div>
                    </div>
                  </div>
                  <div class="row upper-margin">
                    ...
                    <div class="col-md-5 col-md-push-1">
                      <div class="form-group" class="small-device-style">
                        ...
                        <label class="control-label" for="input" style="">確認投資者密碼</label><i class="bar"></i>
                      </div>
                    </div>
                  </div>
                  <div class="row upper-margin1">
                    <div class="col-md-5 col-md-push-1">
                      <div class="form-group">
                        ...
                        <label class="control-label" for="input" style="">金額</label><i class="bar"></i>
                      </div>
                    </div>
                    <div class="col-md-5 col-md-push-1">
                      <div class="form-group">
                        <input type="text" id="dob" style="color: #777;" name="dob" value="{{ old('dob') }}" required="required" />
                        <label class="control-label" for="input" style="">出生日期</label><i class="bar"></i>
                      </div>
                    </div>
                  </div>
                </div>
