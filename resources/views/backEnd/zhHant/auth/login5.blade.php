    ...
    this.blur();    this.focus();  }" />
            ...
            <div class="row" style="margin-top: 30px">
              <div class="col-md-6 col-xs-12 col-sm-6 anc-style no-padding">
                <a href="/reset-password">找回密碼</a>
              </div>
              <div class="col-md-6 col-xs-12 col-sm-6 no-padding">
                <button type="submit" class="mat-form-button">登入</button>
            ...
            <div class="reg-des">
              ...
              <div>
                <a href="/live-account-register">
                  <button type="" class="mat-form-button1">打開模擬賬戶頁面</button>
                </a>
                <a href="/demo-account-register">
                  <button type="" class="mat-form-button2">打開模擬賬戶頁面</button>
                </a>
              </div>
