      ...
      <div class="card">
        <div class="card-block">
          <div class="row">
            <div class="col-md-12">
              <ul class="up-barcurb">
                <li class="first-li "> 1. 选择您的帐户类型</li>
                <li class="second-li selected"> 2. 自定义您的交易账户 </li>
              </ul>
            </div>
          </div>
        </div>
            ...
            <div class="padding15">
              <div class="form-part">
                <div class="row-fluid">
                  ...
                  <div class="form-group">
                    <div class="span4"><label class="control-label">杠杆作用:</label></div>
                    <div class="span4 form-group">
                  ...
                  <div class="form-group">
                    <div class="span8"><label class="control-label">货币:</label></div>
                    <input class="form-control" type="text" disabled="disabled" value="美元" id="currency" style="width: 60%">
                    <div class="span4"></div>
                  </div>
                  <br>
                  <div class="form-group">
                  ...
                  <div class="span4 form-group">
                    <input type="submit" id="submit" class="btn btn-primary" value="创建" name="investor_account">
                  </div>
                          ...
                          <table class="table" id="myTable">
                            <tbody>
                              <tr>
                                <td class="left">
                                  帐户组</td>
                                <td class="left">战略经理帐户</td>
                              </tr>
                              <tr>
                                <td class="left">帐户类型</td>
  ...
  $(function(){
    ...
    $('#passwordField, #c_password').on('keyup', function () {
      ...
      if ($('#passwordField').val() == $('#c_password').val()) {
        $('#message').html('密码匹配').css('color', 'green');
      } else 
    ...
    $('#form_id').on('submit', function(e){
      ...
      if ( o_pass!= s_pass) {
        ...
        $('#message').html('密码不匹配密码不匹配').css('color', 'red');
        e.preventDefault();
      }
      else{
