          ...
          <div class="span12 grey_bg">
            <div class="padding15">
              ...
              <div class="form-group">
                <div class="span8"><label class="control-label">存款:</label></div>
                <input class="form-control" name="deposit" type="text" style="width:60%">   
                <div class="span4"></div>
              </div>
              <div class="form-group">
                <div class="span4"><label class="control-label">账户类型:</label></div>
              ...
              <div class="form-group">
                <div class="span8"><label class="control-label">貨幣:</label></div>
              ...
              <div class=" form-group">
               <!-- <div class="span4"></div> -->
               <div class="span4">
                 <input type="submit" id="submit" class="btn btn-primary" value="创建账户" name="submit"> 
                ...
                <div class="bank-info">
                  ...
                  <div class="bank-table">
                    <table class="table" id="myTable">
                      <tbody>
                        <tr>
                          <td class="left">账户組</td>
                          <td class="left">模拟账户</td>
                        </tr>
                        <tr>
