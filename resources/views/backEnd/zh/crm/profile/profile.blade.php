                            ...
                            <div class="panel panel-light-grey border border-dark" vertilize="" style="height: 138px;">
                                <div class="panel-wrapper collapse in" style="height: auto;">
                                    <div class="panel-body text-center">
                                        @if($condition1)
                                        @if(!$sub_condition1)
                                        <h5 style="display: flex;justify-content: center;">状态 :&nbsp
                                            <div class="approved">
                                                <span ng-class="" data-ng-bind="" class="text-success">已批准</span>   
                                                <i class="fa fa-check" aria-hidden="true"></i>
                                            </div>
                                        </h5>
                                        <p>您的账户已获得完全批准! 您现在可以访问XYZ中的所有功能和服务。 {{$general_info->company_name}}.</p>
                                        @else
                                        <h5 style="display: flex;justify-content: center;">状态 :&nbsp
                                            <div class="approved">
                                                <span ng-class="" data-ng-bind="" class="text-info">有待</span>   
                                                <i class="fa fa-close" aria-hidden="true"></i>
                                            </div>
                                        </h5>
                                        <p>Your account is under approval! You can not access any features and services within {{$general_info->company_name}} without being approved by admin.</p>
                                        @endif
                                        @elseif($condition2)
                                    ...
                                    <div class="panel panel-light-grey border border-dark" vertilize="" >
                                        <div class="panel-wrapper collapse in" style="height: auto;">
                                            <div class="panel-heading pb0" style="display: flex;justify-content: space-between;">
                                                <h4>信息</h4>
                                                <a href="#responsive" data-href="#responsive" data-toggle="modal" style="font-size: 15px;color: #92B0A8"><span style="padding: 4px"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></span>编辑</a>
                                            </div>
                                            ...
                                            <div class="panel-body pt0 pb0">
                                                <table class="table hidden-xs  my_table">
                                                    <tbody>
                                                        <tr>
                                                            <td>身份状态 :</td>
                                                            <td>{!!($profile->ib_status==1?"活性":"不活躍")!!}</td>
                                                        </tr>
                                                                ...
                                                                <div class="dropdown">
                                                                   ...
                                                                   <div class="dropdown-menu" aria-labelledby="about-us1">
                                                                       <ul style="padding-left: 10px">
                                                                           <li>
                                                                               <input type="checkbox" class="noti"  value="newsletter" @if($profile->newsletter == 1) checked @endif >&nbsp 通訊 
                                                                           </li>
                                                                           <li>
                                                                               <input type="checkbox" class="noti" value="market_updates" @if($profile->market_updates == 1) checked @endif>&nbsp 市場更新
                                                                           </li>
                                                                           <li>
                                                                               <input type="checkbox" class="noti" value="trading_statement_daily" @if($profile->trading_statement_daily == 1) checked @endif>&nbsp 交易聲明（每日）
                                                                           </li>
                                                                           <li>
                                                                               <input type="checkbox" class="noti" value="trading_statement_monthly" @if($profile->trading_statement_monthly == 1) checked @endif>&nbsp 交易聲明（每月） 
                                                                           </li>
                                                                       </ul>
                                                                   </div>
                                                               </div><td>
                                                ...
                                                <!-- <div class="panel-footer no-border">
                                                   <p style="font-size: 13px;margin-bottom: 19px">要更改您的电子邮件, 出生日期, 请联系我们的客服部门. </p> 
                                               </div> -->
                                           </div>
                                       </div>
                                   </div>
