        ...
        <div class="inner bg-container">
           ...
           <div class="card">
                        ...
                        <div class="card-block m-t-35">
                            ...
                            <!-- <h2>Okpay Withdraw</h2> -->
                            {!! Form::open(['method' => 'POST','files' => true, 'url' => LaravelLocalization::localizeURL('/okpay_withdraw'), 'name' => 'withdrawForm','class'=>'col-md-7','id'=>'okpayForm']) !!}
                            @if($errors->any())
                    ...
                    <div class="form-group show-form">
                        ...
                        <div class="form-group show-form">
                            ...
                            {!! Form::label('email', 'Okpay Email *') !!}
                        {!! Form::email('email', null, ['class' => 'form-control input-lg',  'placeholder' => 'Enter Okpay Email Address']) !!}
                        ...
                        <div class="form-group hide-form">
                            <table class="table table-bordered ">
                                ...
                                <tr>
                                  ...
                                  <tr>
                                    <td style="font-weight:bold">Okpay Email *</td>
                                    <td class="email"></td>
                                  </tr>
