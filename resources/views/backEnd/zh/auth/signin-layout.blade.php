        ...
        <div class="logo-flex clearfix">
          <div class="col-xs-6 column">
            <div class="header-img clearfix">
              <a href="/">
                <img src="/img/logo.png" alt="logo" style="width:{{$general_info->logo_width}}; height:
                {{$general_info->logo_height}}">
              </a>
            </div>
          </div>
          <div class="col-xs-6">
            <div class="text-center header-right-content column">
              ...
              <div class="button-sign" style="width: 150px">
                <p>开设户口!<span><a href="/live-account-register">注册</a></span></p>
              </div>
              <?php endif ?>
              <?php if (Request::is('live-account-register') || Request::is(app()->getLocale().'/live-account-register')): ?>
              <div class="button-sign" style="width: 150px">
                <p>已有账户!<span><a href="/login">登录</a></span></p>
              </div>
              <?php endif ?>
