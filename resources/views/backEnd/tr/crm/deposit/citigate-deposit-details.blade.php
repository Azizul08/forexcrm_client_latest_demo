        ...
        <div class="inner bg-container">
            ...
            <div class="card">
                ...
                <div class="card-block m-t-35">
                    <h2>Citigate Depozito Detayları</h2>
                    @if(Session::has('msg'))
                    <div class="col-md-12">
...
<table class="table table-bordered ">
    ...
    <tr>
        <td style="font-weight:bold">Ticari hesap</td>
    ...
    <div class="form-group">
        ...
        &nbsp;&nbsp;
        <a href="/citigate_deposit" class="btn btn-primary">İptal etmek</a>
    </div>
    {!!Form::close()!!}
