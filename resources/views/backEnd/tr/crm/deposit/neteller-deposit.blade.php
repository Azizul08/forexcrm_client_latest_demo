...
<div id="content" class="bg-container">
    ...
    <div class="outer">
           ...
           <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <ul class="up-barcurb">
                                        <li class="first-li selected"> 1. Transfer Ayrıntıları</li>
                                        <li class="second-li"> 2. Transferi Onayla </li>
                                    </ul>
                                </div>
                            </div>
        ...
        <thead>
          ...
          <tr>
            <td style="font-weight:bold">Depozito</td>
            <td class="deposit-to"></td>
          </tr>
      <tr>
            <td style="font-weight:bold">Para Yatırma Tutarı</td>
                        ...
                        <div class="">
                            ...
                            <div class="bank-info" style="padding: 0">
                                <ol>
                                    ...
                                    <li>  
                                        İşlem devam ederse, paranın alınmasından sonra paralar işlem hesabınıza gönderilir. {{$general_info->company_name}}.</li>
