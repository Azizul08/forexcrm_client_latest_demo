    		...
    		<div class="row">
                <div class="col-md-12" style="margin: 0;padding: 0">
                    <div class="form-group col-md-6">
                        <label for="" class="inputlg" style="font-size: 18px">E-posta</label>
                        <input id="profile_email" class="form-control input-lg" disabled=""
                         value="{{$profile->email}}" type="text" style="height: 50px">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="" style="font-size: 18px">Ortak Şifresi:</label><br>
                    @if($profile->password_preference == 'client')
                       <input  class="radio-class" id="yes" type="radio" name="password_preference" value="yes" ><span style="margin: 0 5% 0 2%">Partner Şifresini Kullan</span>

                        <input class="radio-class" id="no" type="radio" name="password_preference" value="no" checked><span style="margin: 0 5% 0 2%">İstemci Şifresini Kullan</span>
                    @else
                    <input  class="radio-class" id="yes" type="radio" name="password_preference" value="yes" checked><span style="margin: 0 5% 0 2%">Partner Şifresini Kullan</span>

                    <input class="radio-class" id="no" type="radio" name="password_preference" value="no"><span style="margin: 0 5% 0 2%">İstemci Şifresini Kullan</span>
                    @endif
                    ...
                    <div class="clearfix"></div>
                                ...
                                <div class="radio disabled col-md-6">
                                    <label style="font-size: 16px">
                                        ...
                                        Müşterilerle şahsen tanışıyor musunuz?
                                    </label>
                                </div>
                                <!-- <div class="row"> -->
                                <div class="col-md-6">
                                ...
                                <div class="">
                                    <label for="" style="font-size: 18px">Cinsiyet:</label>
                                <div class="radio">
                                    <label>
                                ...
                                <!-- </div> -->
                                <div class="form-group col-md-6">
                                    <label for="" style="font-size: 18px">Adres:</label>
                                ...
                                <div class="form-group col-md-6">
                                    <label for="" style="font-size: 18px">Doğum tarihi:</label>
	    		...
	    		<!-- <div class="col-md-12"> -->
	    			<div class="document-upload" style="margin-top: 5%">
	    				<h3>Belge Yükle: <span>
                            @if($condition1)
                            @if(!$sub_condition1)
	    					<button type="button" class="btn btn-labeled btn-success" style="margin-left: 3%"><span class="btn-label"><i class="fa fa-check"></i></span>onaylı</button>
                            @else
                            ...
                            @endif
                            @elseif($condition2)
	    					<button type="button" class="btn btn-labeled btn-warning" style="margin-left: 3%"><span class="btn-label"><i class="fa fa-info"></i></span>Kısmen Onaylandı</button></span></h3> 
                            @elseif($condition3) 
                            <button type="button" class="btn btn-labeled btn-danger" style="margin-left: 3%"><span class="btn-label"><i class="fa fa-close"></i></span>Onaylanmamış</button>  
                            @else
                            <button type="button" class="btn btn-labeled btn-danger" style="margin-left: 3%"><span class="btn-label"><i class="fa fa-close"></i></span>kadar</button>	
                            @endif		
	    			</div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group col-md-3">
                            <label for="identity">Ön taraf</label>
                            <input type="file" class="form-control" name="id_front" accept='image/*'>
                        </div>
                        <div class="form-group col-md-3">
                            <label for="identity">Arka tarafı</label>
                            <input type="file" class="form-control" name="id_back" accept='image/*'>
                        </div>
                        <div class="col-md-1 m-t-33">
                        
                        <button type="submit" class="btn btn-success center-block">Yükleme</button>
                            
                        </div>
                        <div class="col-md-1">
                            @if($identity ==1)
                            <div class="tooltip-text">
                                <i class="fa fa-check-circle" aria-hidden="true"><span>Doğrulanmış</span></i>
                            </div>
                            @elseif($identity ==2)
                            <div class="tooltip-text2">
                                <i class="fa fa-times" aria-hidden="true"><span>Doğrulanmadı</span></i>
                            </div>
                            @else
                            <div class="tooltip-text3">
                                <i class="fa fa-info-circle" aria-hidden="true"><span>kadar</span></i>
                            </div>
                            @endif
            ...
            <form action="/save-resident" method="post" class="form-horizontal" style="margin-top: 1%" enctype='multipart/form-data'>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="">
                            <div class="form-group col-md-3">
                                <label for="resident">Dosya</label>
