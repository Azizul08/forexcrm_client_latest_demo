            ...
            <div class="">
                        ...
                        @endif
                            ...
                            <h5 style="display: flex;justify-content: center;">Status :&nbsp
                                <div class="approved">
                                    <span ng-class="" data-ng-bind="" class="text-success">onaylı</span>   
                                    <i class="fa fa-check" aria-hidden="true"></i>
                                </div>
                            </h5>
                            <p>Hesabınız tamamen onaylandı! Artık tüm özellikleri ve içindeki hizmetlere erişebilirsiniz. {{$general_info->company_name}}.</p>
                            @else
                            <h5 style="display: flex;justify-content: center;">Durum:&nbsp
                                <div class="approved">
                                    <span ng-class="" data-ng-bind="" class="text-info">kadar</span>   
                                    <i class="fa fa-close" aria-hidden="true"></i>
                                </div>
                            </h5>
                            <p>Hesabınız onaylandı! İçindeki herhangi bir özellik ve hizmete erişemezsiniz. {{$general_info->company_name}} yönetici tarafından onaylanmadan.</p>
                            @endif
                            @elseif($condition2)
                            <h5 style="display: flex;justify-content: center;">Durum:&nbsp 
                            <div class="not-approved">
                            <span ng-class="" data-ng-bind="" class="text-danger">Onaylanmamış</span>
                            <i class="fa fa-times" aria-hidden="true"></i>
                            </div></h5>
                            <p>Hesabınız onaylanmadı! İçindeki herhangi bir özellik ve hizmete erişemezsiniz. {{$general_info->company_name}}.</p> 
                            @elseif($condition3)
                            <h5 style="display: flex;justify-content: center;"> Durum:&nbsp 
                            <div class="partially-approved">
                            <span ng-class="" data-ng-bind="" class="text-warning">Kısmen Onaylandı</span>
                            <i class="fa fa-info-circle" aria-hidden="true"></i>
                            </div></h5>
                            <p>Hesabınız kısmen onaylandı! İçindeki tüm özelliklere ve hizmetlere erişemezsiniz. {{$general_info->company_name}}.</p>
                            @else
                            <h5 style="display: flex;justify-content: center;">Durum:&nbsp
                            <button type="button" class="btn btn-labeled btn-danger" style="margin-left: 3%"><span class="btn-label"><i class="fa fa-close"></i></span>kadar</button> 
                        </h5>
                            <p>Hesabınız onaylandı! İçindeki herhangi bir özellik ve hizmete erişemezsiniz. {{$general_info->company_name}} yönetici tarafından onaylanmadan.</p>
                            @endif
                                            ...
                                            <div class="panel panel-light-grey border border-dark" vertilize="" >
                                                <div class="panel-wrapper collapse in" style="height: auto;">
                                                    <div class="panel-heading pb0" style="display: flex;justify-content: space-between;">
                                                        <h4>Bilgi</h4>
                                                        <a href="#responsive" data-href="#responsive" data-toggle="modal" style="font-size: 15px;color: #92B0A8"><span style="padding: 4px"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></span>Düzenle</a>
                                                    </div>
                                            ...
                                            <div class="panel panel-light-grey border border-dark" vertilize="" style="overflow: auto" >
                                                <div class="panel-wrapper collapse in" style="height: auto;">
                                                    ...
                                                    <div class="panel-body pt0 pb0">
                                                       ...
                                                       <div class="dropdown-menu" aria-labelledby="about-us1">
                                                           <ul style="padding-left: 10px">
                                                               <li>
                                                                   <input type="checkbox" class="noti"  value="newsletter" @if($profile->newsletter == 1) checked @endif >&nbsp Bülten
                                                               </li>
                                                               <li>
                                                                   <input type="checkbox" class="noti" value="market_updates" @if($profile->market_updates == 1) checked @endif>&nbsp Piyasa Güncellemeleri
                                                               </li>
                                                               <li>
                                                                   <input type="checkbox" class="noti" value="trading_statement_daily" @if($profile->trading_statement_daily == 1) checked @endif>&nbsp Ticaret Bildirimi (Günlük)
                                                               </li>
                                                               <li>
                                                                   <input type="checkbox" class="noti" value="trading_statement_monthly" @if($profile->trading_statement_monthly == 1) checked @endif>&nbsp Ticaret Beyanı (Aylık)
                                                               </li>
                                                           </ul>
                                                       </div>
                                                   </div><td>
                                                    ...
                                                    <!-- <div class="panel-footer no-border">
                                                       <p style="font-size: 13px;margin-bottom: 19px">
                                                        E-postanızı değiştirmek için Doğum Tarihi lütfen Destek Departmanımızla iletişime geçin. </p> 
                                                    </div> -->
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header bg-success">
                                ...
                                <h4 class="modal-title text-white">Bilgilerinizi Düzenleyin:</h4>
                            </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-4 text-lg-right">
                                                <label for="country" class="form-control-label">ülke
                                                    :</label>
                                            </div>
                                            <div class="col-xl-6 col-lg-8">
                                                <div class="input-group">
                                                    <select name="country" id="country"  required="required" class="form-control">
                    <option value="" code="">Ülke Seç</option>
                        ...
                        @endforeach
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-4 text-lg-right">
                                                <label for="state" class="form-control-label">Belirtmek, bildirmek
                                                    :</label>
                                            </div>
                                            <div class="col-xl-6 col-lg-8">
                                                <div class="input-group">
                                                    <select name="state" id="state"  required="required" class="form-control">
                    <option value="" id="">Eyalet seçiniz</option>
                        ...
                        <option value="{{$profile->state}}">{{$profile->state}}</option>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-4 text-lg-right">
                                                <label for="city" class="form-control-label">Kent
                                                    :</label>
                                            </div>
                                            <div class="col-xl-6 col-lg-8">
                                                <div class="input-group">
                                                    <select name="city" id="city"  required="required" class="form-control">
                    <option value="" id="">Şehir seç</option>
                        ...
                        <option value="{{$profile->city}}">{{$profile->city}}</option>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-4 text-lg-right">
                                                <label for="zip" class="form-control-label">Posta kodu
                                                    :</label>
                                            </div>
                                            <div class="col-xl-6 col-lg-8">
                                                <div class="input-group">
                                        ...
                                        <div class="form-group gender_message row">
                                            <div class="col-lg-4 text-lg-right">
                                                <label fpr="mobile" class="form-control-label">Telefon numarası :</label>
                                            </div>
                                            <div class="col-xl-6 col-lg-8">
                                                <div class="input-group">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-success" value="update">Değişiklikleri Kaydet</button>
