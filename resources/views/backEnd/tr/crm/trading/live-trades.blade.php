                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                          @if(count($accounts)>0)
                                                ...
                                                <td class="last-td"><div class="dropdown">
                                                  ...
                                                  <ul class="dropdown-menu form-dropdown" aria-labelledby="dropdownMenu1">
                                                    <li><a href="/deposit-funds?ac={{$account->account_no}}">Para Yatırma Fonları</a></li>
                                                            ...
                                                            <li><a href="/profile">hesap detayları</a></li>
                                            ...
                                            @else
                                            <tr>
                                               <td colspan="14" style="text-align:center;"><strong>Çalışan Koşu Yok</strong></td>
                                            </tr>
                                            @endif
                                        </tbody>
                                    </table>
              ...
              <div class="col-sm-12">
                <table class="display table table-bordered nowrap  no-footer" id="commission_table1" role="grid" aria-describedby="commission_table1_info" style="width: 100%;" width="100%">
                                 <thead style="white-space:nowrap;">
                                    <tr role="row">
                                      <th class="sorting_asc" rowspan="1" colspan="1" style="width: 49.5px;" aria-label="SR No."><span>hesap</span></th>
                                      ...
                                      <th class="sorting" tabindex="0" aria-controls="commission_table1" rowspan="1" colspan="1" style="width: 88.5px;" aria-label="Account No.: activate to sort column ascending">Time</th>
                                      <th class="sorting" tabindex="0" aria-controls="commission_table1" rowspan="1" colspan="1" style="width: 102.5px;" aria-label="Account Type.: activate to sort column ascending">Type</th>
...
echo '<tr><td colspan="14" style="text-align:center;"><strong>No Running Trades</strong></td></tr>';
                              ...
                              <div id="commission_table1_processing" class="dataTables_processing panel panel-default" style="display: none;">İşleme...</div>
                            </div>
                          </div>
                          <div class="row">
                            <!-- <div class="col-sm-5">
