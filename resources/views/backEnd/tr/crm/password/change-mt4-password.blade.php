                ...
                <div class="card-block m-t-35">
                   <!--  <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="up-barcurb">
                                <li class="first-li selected">1. Şifrenizi Değiştirin</li>
                                <li class="second-li"> 2. Kodu Onayla </li>
                            </ul>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                                ...
                                <div class="select-account-body">
                                    <h4>MT4 şifresini değiştir</h4>
                                        ...
                                        <div class="form-group">
                                            <div class="span3 " style="margin-top: 5px;"><label class="control-label">Hesap Seç:</label></div>
                                            <div class="span4 form-group">
                                                <select name="account_no" class="form-control" id="account_no" >
                                                    <option value="" disabled="disabled" selected="selected">Hesap Seç</option>
                           ...
                           <div class="col-md-6">
                            <div class="card select-account" style="height: auto">
                                <div class="select-account-body">
                                    <h4>Yatırımcı Şifresini Değiştirin</h4>
                                    ...
                                    <div class="form-group">
                                      <label for="investor_password">Parola:</label>
                                    ...
                                    <div class="form-group">
                                        <label for="cinvestor_password">Şifreyi Onayla:</label>
...
<script type="text/javascript">
    $(function(){
        ...
        form.validate({
            ...
            messages : {
                account_no : {
                    required: "Lütfen hesap seç",
                },
                password : {
                    required: "Şifre gereklidir",
                },
                c_password : {
                    required: "Şifrenizi uygun",
                },
            }
        });
        form1.validate({
