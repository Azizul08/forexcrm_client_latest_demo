...
@section('title', 'Open Trading Account')
                              ...
                              <div class="span12 grey_bg">
                                <div class="padding15">
                                  ...
                                  <div class="form-group">
                                    <div class="span3"><label class="control-label">Açmak istiyorum:</label></div>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <!-- <div class="control-group">
                                      ...
                                      <div class="form-group">
                                        <label for="c_password">Şifreyi Onayla:</label>
