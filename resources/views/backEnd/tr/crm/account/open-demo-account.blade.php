           ...
           <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <ul class="up-barcurb">
                                        <li class="first-li "> 1. Hesap türünüzü seçin</li>
                                        <li class="second-li selected"> 2. Ticaret hesabınızı özelleştirin </li>
                                    </ul>
                                </div>
                            </div>
                            <!-- <div class="row">
                        ...
                        @endif
                            {!! Form::open(['method' => 'POST','files' => true, 'url' => LaravelLocalization::localizeURL('/open-demo-account'), 'name' => 'withdrawForm','class'=>'col-md-7 form form-horizontal','id'=>'form_id']) !!}
                                <div class="form-group">
                                        <div class="span8"><label class="control-label">Depozito:</label></div>
                                    ...
                                    <div class="form-group">
                                        <div class="span4"><label class="control-label">Hesap tipi:</label></div>
                                    ...
                                    <div class="form-group">
                                        <div class="span4"><label class="control-label">Kaldıraç:</label></div>
                                        <div class="span4 form-group">
                                            <select name="leverage" class="form-control" id="leverage" required="required" style="width: 60%">
                                                <option value="">Kaldıraç Seç</option>
                                    ...
                                    <div class="form-group">
                                        <div class="span8"><label class="control-label">Para birimi:</label></div>
                                  ...
                                  <div class=" form-group">
                                     <!-- <div class="span4"></div> -->
                                     <div class="span4">
                                     <input type="submit" id="submit" class="btn btn-primary" value="Create an Account" name="submit"> 
                                     <a href="/open-new-account" style="margin-left: 10px">Önceki adım</a> 
                            ...
                            <div class="bank-info">
                                ...
                                <div class="bank-table">
                                    <table class="table" id="myTable">
                                        <tbody>
                                            <tr>
                                                <td class="left">Hesap grubu</td>
                                                <td class="left">Demo Hesabı</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td class="left">Hesap Para Birimi</td>
...
<script type="text/javascript">
        $(function(){
            ...
            var form = $("#form_id");
                ...
                messages:{
                    deposit : {
                        required :"Lütfen depozito değerini giriniz"
                    },
                    account_type:{
                    required:"Lütfen hesap türünü seçiniz"
                    },
                    leverage:{
                    required:"Kaldıraç seçiniz",
                    },
                    password:{
