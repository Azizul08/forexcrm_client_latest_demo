                            ...
                            <form action="#" class="form-group row form_inline">
                              <div class="col-md-2"></div>
                                 <div class="form-group col-md-3">
                                  <label for="transaction_type" class=" form-control-label">Transfer Türü</label>
                                  <select name class="form-control" id="transaction_type">
                                    ...
                                    <option value="credit_in">Kredi İçeriği</option>
                                    <option value="credit_out">Kredi Çıkışı</option>
                                    <option value="int_tx">İç transfer</option>
                                  </select>
                                </div>
                                <div class="col-md-1"></div> 
                                <div class="form-group col-md-6">
                                    <label for="">
                                        Transfer tarihi</label>
