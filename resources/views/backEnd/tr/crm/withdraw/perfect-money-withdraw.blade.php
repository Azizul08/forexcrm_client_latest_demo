           ...
           <div class="card">
                        ...
                        <div class="card-block m-t-35">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <ul class="up-barcurb">
                                        <li class="first-li selected"> 
                                            1. Transfer Detayları</li>
                        ...
                        <div class="form-group hide-form">
                            <table class="table table-bordered ">
                                <thead>
                                  <tr>
                                    <td colspan="2" style="text-align: left;"><b>
                                        Lütfen aşağıdaki ayrıntıları doğrulayın ve ödeme yapın</b></td>
                                  </tr>
                              </thead>
                                  <tr>
                                ...
                                <tr>
                                  ...
                                  <tr>
                                    <td style="font-weight:bold">Mükemmel Para E-postası *</td>
                                    <td class="email"></td>
                                  </tr>
