        ...
        <div class="inner bg-container">
           ...
           <div class="card">
                        ...
                        <div class="card-block m-t-35">
                            ...
                            <!-- <h2>Neteller Withdraw</h2> -->
                            {!! Form::open(['method' => 'POST','files' => true, 'url' => LaravelLocalization::localizeURL('/neteller_withdraw'), 'name' => 'withdrawForm','class'=>'col-md-7','id'=>'netellerForm']) !!}
                            @if($errors->any())
                            ...
                            <option value="{{$account->account_no}}" @if($selected_account==$account->account_no) selected="selected" @endif>{{$account->acc_no}} {{$account->balance}} Amerikan Doları</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group show-form">
                        ...
                        {!! Form::email('email', null, ['class' => 'form-control input-lg',  'placeholder' => 'Enter Neteller Email Address']) !!}
                        ...
                        <div class="form-group hide-form">
                            <table class="table table-bordered ">
                                ...
                                <tr>
                                  ...
                                  <tr>
                                    <td style="font-weight:bold">NETELLER Hesap Kimliği *</td>
                                    <td class="account-id"></td>
                                  </tr>

                                  <tr>
                                    <td style="font-weight:bold">Neteller E-posta *</td>
                                    <td class="email"></td>
                                  </tr>
                        ...
                        <div class="">
                            ...
                            <div class="bank-info" style="padding: 0">
                                <ol>
                                    ...
                                    <li>  
                                        İşlem devam ederse, paranın alınmasından sonra paralar işlem hesabınıza gönderilir. {{$general_info->company_name}}. İşlem süresi genellikle 3-5 iş günüdür. Bankada gecikme olabilir veya {{$general_info->company_name}} bilgilerinizi doğrulayamıyor. Lütfen banka havalesi onayınızı kaydedin, böylece gerekirse tüm ayrıntıları kontrol edebiliriz.</li>
    ...
    $(function(){
        ...
        $('.transfer-button').click(function(){
           if($('#netellerForm').valid()==true) {
                ...
                $('.hide-form').show(500);
                $('.show-form').hide(300);
                $('#transfer_from_confirm').html($('#transfer_from').val());
                
                $('#amount_confirm').html($('#amount').val());
                $('.t_email').html($('input[name=email]').val());
