            ...
            <div class="card">
                <div class="card-block m-t-35">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="up-barcurb">
                                <li class="first-li selected"> 1. Kaldıraç Hesabınızı seçin</li>
                                <li class="second-li"> 2. Leverage hesabınızı özelleştirin </li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="padding15">
                        ...
                        @endif
                            ...
                            {!! Form::open(['method' => 'POST','files' => true, 'url' => LaravelLocalization::localizeURL('/change-leverage'), 'name' => 'withdrawForm','id' => 'withdrawForm','class'=>'col-md-7 form form-horizontal']) !!}
                                    ...
                                    <div class="form-group ">
                                        <div class="span4 "><label class="control-label">Yeni Kaldıraç:</label></div>
                                        <div class="span4 form-group">
                                ...
                                <div class="bank-table">
                                    <table class="table" id="myTable">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="left">Hesap numarası</td>
                                                <td class="left" id="type_account"></td>
                                            </tr>
                                            <tr>
                                                <td class="left">Hesap Para Birimi</td>
                                                <td class="left" id="currency_show">Amerikan Doları</td>
                                            </tr>
                                            <tr>
