 ...
 <!--  <div class="preloader-wrapper">
    ...
    <section class="main-body">
      <div class="container">
        ...
        {{ csrf_field() }}
            <h4 class="form-reset-h4">Şifreyi yenile</h4>
            <small>Şifrenizi sıfırlamak için lütfen bize e-posta adresinizi verin.</small>
            <div class="form-group">
              ...
              <div class="col-md-6 col-xs-12 no-padding">
                <button type="submit" class="reset-mat-form-button">Gönder</button>
              </div>
            </form>
          </div>
    ...
    feedbackIcons: {
        ...
        fields : {
          email: {
                validators: {
                    notEmpty: {
                        message: 'E-posta adresi gerekli ve boş bırakılamaz'
                    },
                    emailAddress: {
