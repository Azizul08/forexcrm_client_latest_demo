          ...
          <div class="col-md-12 col-xs-12  form-div-height">
            ...
            <div class="col-md-8 col-md-push-5 col-xs-12  col-sm-8 text-center">
              ...
              <form id="myform" method="post" action="{{LaravelLocalization::localizeURL('/live-account-register')}}">
                ...
                <ul id="progressbar">
                  <li class="active"><span style="color: #777">Kişisel bilgi</span></li>
                  <li><span style="color: #777">Kişisel bilgi</span></li>
                  <li><span style="color: #777">Hesap Bilgileri</span></li>
                  <li><span style="color: #777">ayrıntılar</span></li>
                </ul>

                <fieldset id="x">
                  <h2 class="fs-title">Kişisel bilgi</h2>
                  <hr>
                ...
                <div class="row">
                  ...
                  <div class="col-md-8 col-md-push-2">
                    ...
                    <div class="form-group">
                      ...
                      <label class="control-label" for="input">Şifreyi Onayla</label><i class="bar"></i>
                    </div>
                  </div>
                  ...
                  <fieldset id="a">
                    ...
                    <div class="col-md-6 clearfix">
                      ...
                      <div class="wrap">
                        ...
                        <div class="select">
                          ...
                          <span class="select-highlight"></span>
                          <span class="select-bar"></span>
                          <small class="label-style">Eyalet seçiniz</small>
                        </div>
                        <!--Select with pure css-->
                    ...
                    <div class="col-md-6 clearfix">
                      ...
                      <div class="wrap">
                        ...
                        <div class="select" style="margin-top: -7%">
                          ...
                          <span class="select-highlight"></span>
                          <span class="select-bar"></span>
                          <small class="label-style">Şehir seç</small>
                        </div>
                        <!--Select with pure css-->
                    ...
                    <div class="col-md-6 clearfix">
                      ...
                      <div class="form-group">
                        ...
                        <label class="control-label" for="input">Posta kodu</label><i class="bar"></i>
                      </div>
                    </div>
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="form-group">
                        ...
                        <label class="control-label" for="input">Adres</label><i class="bar"></i>
                      </div>
                    </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <label class="control-label" for="input">Doğum günü</label><i class="bar"></i>
                      </div>
              ...
              <fieldset id="y">
                <h2 class="fs-title">Hesap Bilgileri</h2>
                <hr>
                  ...
                  <div class="row">
                    <div class="col-md-8 col-md-push-2">
                      <div class="form-group">
                        ...
                        <label class="control-label" for="input" style="margin-top: 2%">Ticaret Şifresini Onayla</label><i class="bar"></i>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-8 col-md-push-2">
                      <div class="form-group">
                        ...
                        <label class="control-label" for="input" style="margin-top: 2%">Yatırımcı Şifresini Doğrulayın</label><i class="bar"></i>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="col-md-8 col-md-push-2">
                    ...
                    <div class="form-group">
                      ...
                      <label class="control-label checkbox-inline small-label" for="input" style="">Şartlar ve koşullar ile katılıyorum</label><!-- <i class="bar"></i> -->
                    </div>
                  </div>
              ...
              <fieldset id="z">
                <h2 class="fs-title">ayrıntılar</h2>
                <hr>
...
messages: {
  ...
  phone : {
    required : "Lütfen geçerli telefon numarası girin.",
