...
.text {
  ...
  margin-left:auto;
  top:30%;
  box-shadow: 0px 0px 30px #27414C;
        ...
        <div class="logo-flex clearfix">
          <div class="col-xs-6 column">
            <div class="header-img clearfix">
              <a href="/"><img src="/img/logo.png" alt="logo" style="width:100px;height:50px"></a>
            </div>
          </div>
          <div class="col-xs-6">
...
<svg id="Layer_1" width="795.9" height="433" viewBox="0 0 795.9 433">
...
<div class="text">
  <div class="text-inner">
    ...
    <h2> Es scheint, dass die Seite, die Sie suchen, verloren ist.
Bitte kontaktieren Sie unser Support-Team zur Anfrage. </h2>
